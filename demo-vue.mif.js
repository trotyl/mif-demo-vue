System.pkgInfo({
  ...
  "dependencies": {
    "moment": {
      "version": "^2.22.2",
      "path": "./auto-import-moment.mif.js"
    }
  }
});
System.register('mif', ['moment'], function (exports, module) {
    'use strict';
    var moment;
    return {
        ...
        execute: function () {
            ...
            ***************************************************************************** */
            ...
            var Component = /** @class */ (function () {
                ...
                Component.prototype.onUpdate = function (_changes) { };
                ...
                Component.prototype.set = function (state) {
                    ...
                    this.state = state;
                    this.onUpdate({ previous: previous, current: state });
                };
            ...
            var basePath = base != null ? base.href : '/';
            ...
            function createRecosComponent(sku) {
            ...
            var GreenRecos = exports('GreenRecos', /** @class */ (function (_super) {
                __extends(GreenRecos, _super);
                function GreenRecos() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                GreenRecos.prototype.onCreate = function () {
                    var host = document.createElement('div');
                    this.instance = createRecosComponent('');
                    return host;
                };
                GreenRecos.prototype.onAttach = function () {
                    this.instance.$mount(this.node);
                };
                GreenRecos.prototype.onUpdate = function (_a) {
